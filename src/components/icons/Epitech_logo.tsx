...
export const EpitechLogo = (
    props: ComponentPropsWithoutRef<"svg"> & {size?: number}
) => {
    const scaledWidth = props.size ? props.size * 1.3 : undefined;
